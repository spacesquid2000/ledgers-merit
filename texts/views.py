...
def diarydate(request):
    ...
    s2p1 = ('As I was strolling through my fields, I ', 'As I was walking in the town square, I ', 'During my visit to the teahouse, I ', 'While meandering through the countryside, I')
    ...
    html = "The date is %s %s, %s. Today was %s and I feel %s. %s %s. In addition I %s." % (month1, day1, year1, s1_emotions_var1, s1_emotions[s1_emotions_var1], s2_var1, mer_var1, random.choice(list(ledger_mer.keys())))
